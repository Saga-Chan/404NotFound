...
public class Game_specifications {
	...
	public Game_specifications(SpriteBatch sb) {
		...
		timecount = 0;
		score = 0;
		//on utilise une autre caméra séparée de celle-ci du jeu
		...
		//on définit les labels :textes qu'on va afficher en haut de l'écran
		countdownLabel = new Label(String.format("%03d", worldTimer), new Label.LabelStyle(new BitmapFont(),Color.WHITE)); //%03d pour le nombre de chiffres entier qui vont etre affichés
